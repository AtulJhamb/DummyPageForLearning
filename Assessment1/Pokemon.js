//Code is available at the end of the program
...
var pokemonData={
  ...
  }, 
  {
	...
	var getPokemonDetails=function(name)
	{
		...
		{
			if(name==pokemonData.pokemon[x].name)
			{
				//Showing and taking input from the available options from user
				var details="Information about the pokemon"+"<br>Name : "+pokemonData.pokemon[x].name+", <br>Type : "+pokemonData.pokemon[x].type+", <br>Weight : "+pokemonData.pokemon[x].weight+", <br>Height : "+pokemonData.pokemon[x].height+", <br>Candy : "+pokemonData.pokemon[x].candy+", <br>Egg : "+pokemonData.pokemon[x].egg+", <br>Spawn_chance : "+pokemonData.pokemon[x].spawn_chance+",  <br>Average_Spawn : "+pokemonData.pokemon[x].avg_spawns+",  <br>Spawn Time : "+pokemonData.pokemon[x].spawn_time+",  <br>Multipliers : "+pokemonData.pokemon[x].multipliers+",  <br>Weakness : "+pokemonData.pokemon[x].weaknesses;
	...
	var checkNextEvolution=function(nextEvolution)
	{
		var flag=1;
		var getData=[];
		for(x in pokemonData.pokemon)
		{	
			...
			if(pokemonData.pokemon[x].next_evolution!=undefined)
			{								
				var len=pokemonData.pokemon[x].next_evolution.length;				
				for(i=0; i<len; i++)
				{					
					if(nextEvolution==pokemonData.pokemon[x].next_evolution[i].name)
					{	
						document.write(flag+". "+pokemonData.pokemon[x].name+"<br>");
						flag++;
					}					
				}				
			}			
	...
	var checkWeakness=function(weakness)
	{
		var flag=1;
		for(x in pokemonData.pokemon)
		{
			var len=pokemonData.pokemon[x].weaknesses.length;			
			for(i=0; i<len; i++)
			{				
				if(weakness==pokemonData.pokemon[x].weaknesses[i])
				{
					document.write(flag+". "+pokemonData.pokemon[x].name+"<br>");
					flag++;
				}
	...
	var choice=window.prompt("Please choose from the following options:\n1. Press 1 to enter pokemon name to see all information about that pokemon\n2.Press 2 to enter pokemon name and check which all pokemon are having same name in next evolution\n3.Press 3 To enter the weakness name to see all pokemon who are having same weakness");
	
	choice=Number(choice);
	var enterName,enterWeakness;
	
	switch(choice)
	{
		case 1:enterName=window.prompt("Please enter pokemon name");
			   getPokemonDetails(enterName);
				break;
		case 2:enterName=window.prompt("Please enter pokemon name");
				checkNextEvolution(enterName);
				break;
		case 3:enterWeakness=window.prompt("Please enter weakness name");
				checkWeakness(enterWeakness);
				break;
		default:alert("Please enter a valid option between 1 to 3");
		break;			   
	}		
